...
---------------------------------------------------------*/
  ...
  describe('por una dada promiseA (pA)', function () {
    ...
    describe('que devuelve promiseB (pB) via `.then`:', function () {
      ...
      it(
        'si pA es completado pero no tiene un success handler, pb es completado con el valor de pA',
        function (done) {
          var promiseB = promiseA.then();
      ...
      it(
        'Si pA es rechazado pero no tiene un error handler, pB es rechazado con la razón de pA',
        function (done) {
          var promiseB = promiseA.then();
      ...
      it(
        'si el success handler de pA retorna un valor `x` pB es completado con `x`',
        function (done) {
      ...
      it(
        'si el error handler de pA retorna un valor `x`, pB es completado con `x`',
        function (done) {
      ...
      it(
        'si el success handler de pA arroja una razon `e`, pB es rechazada con `e`',
        function (done) {
      ...
      it(
        'si el error handler de pA arroja una razon `e`, pB es rechazada con `e`',
        function (done) {
      ...
      it(
        'si el success handler de pA retorna pZ que se completa, pB imita a pZ',
        function (done) {
      ...
      it(
        'si el error handler de pA retorna pZ la cual se completa, pB imita a pZ',
        function (done) {
          var promiseZ = new $Promise(noop);
      ...
      it(
        'si el success handler de pA retorna pZ que se rechaza, pB imita a pZ',
        function (done) {
          var promiseZ = new $Promise(noop);
          var promiseB = promiseA.then(function () {
            return promiseZ;
      ...
      it(
        'si el error handler de pA retorna pZ que se rechaza, pB imita a pZ',
        function (done) {
          var promiseZ = new $Promise(noop);
          var promiseB = promiseA.catch(function () {
            return promiseZ;
