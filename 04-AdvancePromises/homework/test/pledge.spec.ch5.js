...
---------------------------------------------------------*/
  ...
  describe('El método estático `$Promise.all`', function () {
    ...
    it('rechaza con <razon E> cuando uno de las promesas ingresadas rechaza con <razon E>', function (done) {
      ...
      setTimeout(
        () => promiseThatRejects._internalReject('any Black Mirror episode'),
        doomsday,
      );
    ...
    it('no es afectado por rechazos adicionales', function (done) {
      ...
      setTimeout(
        () => doomed._internalReject('I am the first rejection'),
        doomsday,
      );
      setTimeout(
        () => reallyDoomed._internalReject('I am too late, ignore me'),
        postApocalypse,
      );
